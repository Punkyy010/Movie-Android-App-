...
public class UnseenActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        nv.setNavigationItemSelectedListener(new NavigationView.OnNavigationItemSelectedListener() {
            ...
            public boolean onNavigationItemSelected(@NonNull MenuItem item) {
                ...
                {
                    case R.id.allmovies:
                        startActivity(new Intent(UnseenActivity.this, MoviesActivity.class));
                       break;
                    case R.id.unseenmovies:
                        startActivity(new Intent(UnseenActivity.this, UnseenActivity.class));
                        break;
                    case R.id.seenmovies:
                        startActivity(new Intent(UnseenActivity.this, SeenActivity.class));
                        break;
                    default:
                        return true;
                }
    ...
    private void populateMovies(final ArrayList<Movie> movies) {
        ...
        mAdapter = new MoviesUnseenAdapter(moviesArrayList, new AdapterItemClickListener() {
    ...
    private void onClicked(View view, int position){
        ...
        if (mTwoPane) {
            ...
            Intent intent = new Intent(context, MoviesUnseenActivity.class);
    ...
    private void loadMovies(){
        ...
        List<Movie> movies = dbHandler.getUnseenMovies();
