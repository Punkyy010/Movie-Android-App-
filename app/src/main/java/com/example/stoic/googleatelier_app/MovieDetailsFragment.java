...
public class MovieDetailsFragment extends Fragment {
    ...
    public void onViewCreated(View view, Bundle savedInstanceState) {
        ...
        ((MovieDetailsActivity) getActivity()).setActionBarTitle(movieName);
        ...
        expandedImageView = (ImageView) view.findViewById(
                R.id.expanded_image);
        container = view.findViewById(R.id.svContainer);

       // mPlayButton = view.findViewById(R.id.checkRemember);
        // Default button, if need set it in xml via background="@drawable/default"
        //mPlayButton.setBackgroundResource(R.drawable.icon1);
