...
public class SeenActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        nv.setNavigationItemSelectedListener(new NavigationView.OnNavigationItemSelectedListener() {
            ...
            public boolean onNavigationItemSelected(@NonNull MenuItem item) {
                ...
                {
                    case R.id.allmovies:
                        startActivity(new Intent(SeenActivity.this, MoviesActivity.class));
                        break;
                    case R.id.unseenmovies:
                        startActivity(new Intent(SeenActivity.this, UnseenActivity.class));
                        break;
                    case R.id.seenmovies:
                        startActivity(new Intent(SeenActivity.this, SeenActivity.class));
                        break;
                    default:
                        return true;
                }
    ...
    private void populateMovies(final ArrayList<Movie> movies) {
        ...
        mAdapter = new MoviesSeenAdapter(moviesArrayList, new AdapterItemClickListener() {
    ...
    private void onClicked(View view, int position){
        ...
        if (mTwoPane) {
            MoviesSeenFragment fragment = new MoviesSeenFragment();
            ...
            Intent intent = new Intent(context, MoviesSeenActivity.class);
    ...
    private void loadMovies(){
        ...
        List<Movie> movies = dbHandler.getSeenMovies();
