...
public class MoviesUnseenAdapter extends RecyclerView.Adapter<MoviesUnseenAdapter.MyViewHolder2>{
            ...
            checkBox.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View v) {
                    if (checkBox.isChecked()) {
                        ...
                        dbHandler.addSeenHandler(new Movie(tvMovieName.getText().toString().trim(), rbMovieRating.getRating(), movieGenre,
                                movieDescription, movieActors, moviePhotoBase64, null,Boolean.toString(checkBox.isChecked())));


                        dbHandler.deleteHandler("Movies_Unseen",tvMovieName.getText().toString().trim());
                        removeSingleItem(getAdapterPosition());
                        Toast.makeText(v.getContext(),"Moved to Seen Movies",Toast.LENGTH_LONG).show();
    ...
    public MoviesUnseenAdapter(ArrayList<Movie> myDataset,AdapterItemClickListener item) {
