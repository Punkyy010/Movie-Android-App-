...
public class MoviesAdapter extends RecyclerView.Adapter<MoviesAdapter.MyViewHolder>{
            ...
            checkBox.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View v) {
                    if (checkBox.isChecked()) {
                        ...
                        dbHandler.addUnseenHandler(new Movie(tvMovieName.getText().toString().trim(), rbMovieRating.getRating(), movieGenre,
                                movieDescription, movieActors, moviePhotoBase64, null,Boolean.toString(checkBox.isChecked())));
                        dbHandler.deleteHandler("Movie",tvMovieName.getText().toString().trim());
                        removeSingleItem(getAdapterPosition());
                        Toast.makeText(v.getContext(),"Moved to Want to see movies",Toast.LENGTH_LONG).show();
                    }
                }
            });
    ...
    public MoviesAdapter(ArrayList<Movie> myDataset,AdapterItemClickListener item) {
    ...
    public MyViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        ...
        return new MyViewHolder(rlMovieItemContainer);
    }
